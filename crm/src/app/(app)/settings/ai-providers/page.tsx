...
const AI_PROVIDERS: AIProvider[] = [
  ...
  { id: 'ollama', name: 'Ollama (Local)', description: 'Self-hosted AI for data privacy. It runs on your machine, no data leaves', keyPlaceholder: 'http://localhost:11434', docsUrl: 'https://ollama.com/', icon: '🏠', category: 'local' },
  { id: 'gemini', name: 'Google Gemini', description: 'Image generation and editing, used by the cinematic sites pipeline', keyPlaceholder: 'AIza...', docsUrl: 'https://aistudio.google.com/apikey', icon: '✨', category: 'image' },
  ...
  { id: 'elevenlabs', name: 'ElevenLabs', description: 'AI voice agents: manages the voice concierge on cinematic sites', keyPlaceholder: 'sk_...', docsUrl: 'https://elevenlabs.io/', icon: '🎙️', category: 'voice' },
  { id: 'wavespeed', name: 'WaveSpeed', description: 'Kling v3 video animation for cinematic hero generation', keyPlaceholder: '...', docsUrl: 'https://wavespeed.ai/', icon: '🌊', category: 'video' },
]
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <ul className="mt-2 space-y-1 text-xs text-[var(--muted)]">
              ...
              <li>• <strong>Claude/OpenAI/DeepSeek:</strong> Direct API access. Use it if you want to bypass OpenRouter for specific models</li>
              ...
              <li>• <strong>ElevenLabs:</strong> Voice agent management: update the knowledge base, change voice, view call logs</li>
